# go design\_pattern\_builder

插一句，如果一个`struct`类型变量，若是属性都是小写开头的话（private），那么`json.Marshal`方法是序列化不出来的。([Go的json解析：Marshal与Unmarshal](https://blog.csdn.net/zxy\_666/article/details/80173288))
...
参考了该篇文章例子：[Java设计模式14：建造者模式](https://blog.csdn.net/weixin\_38230747/article/details/88560118)
